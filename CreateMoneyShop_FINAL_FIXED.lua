--[[
	🎀 SANRIO SHOP — FINAL FIXED VERSION (LocalScript)
	
	ALL FIXES INCLUDED:
	1. ✅ Shop button persists after respawn
	2. ✅ "Processing" state properly updates to toggle after purchase
	3. ✅ Gamepass thumbnails load correctly
	4. ✅ Auto-refresh shop UI after purchase
	5. ✅ Toggle state persists and works immediately
--]]
...
local function createShopButton()
	...
	buttonScreen.ResetOnSpawn = false  -- This ensures it persists through respawn
...
screen.ResetOnSpawn = false  -- Make sure shop GUI persists
...
print("🎀 SANRIO SHOP — Final fixed version loaded! All issues resolved:")
print("  ✅ Shop button persists after respawn")
print("  ✅ Gamepass purchases update immediately")
print("  ✅ Auto-collect toggle works right after purchase")
print("  ✅ All gamepass thumbnails load correctly")