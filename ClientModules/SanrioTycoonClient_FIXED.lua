--[[
    ...
    FIXED VERSION - Corrects module path issues
]]
...
local ClientModules = script.Parent:WaitForChild("ClientModules")  -- FIXED: Added ClientModules folder reference
...
print("[SanrioTycoonClient] 🎮 Sanrio Tycoon Client v2.0.1 Ready!")
